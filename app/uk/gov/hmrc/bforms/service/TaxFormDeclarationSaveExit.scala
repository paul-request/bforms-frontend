...
object TaxFormDeclarationSaveExit {
  ...
  implicit def nameLater(implicit repository: LandfillTaxDeclarationRepository): TaxFormDeclarationSaveExit[Either[LandfillTaxDetailsDeclaration, Map[String, String]]] = {
